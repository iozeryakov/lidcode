    ...
    <MainLayout>
      <div className="flex flex-col py-5 px-[10px] sm:px-[30px] w-full max-w-5xl bg-white rounded-lg shadow-[0px_0px_8px_rgb(215,218,224)] gap-[10px] ">
        ...
        <div className="flex  max-h-[200px] h-[200px] md:max-h-[250px] md:h-[250px] lg:max-h-[300px] lg:h-[300px] w-full max-w-5xl  felx border border-[rgb(243,244,246)] rounded-lg  overflow-hidden">
          <div className="flex  justify-center max-w-[100px] sx:max-w-[150px] sm:max-w-[200px] md:max-w-[250px] lg:max-w-[300px] lg:h-[300px] w-full h-[200px] md:h-[250px]">
            <img
              src="/img/1.png"
              alt="event"
        ...
        <div>
          <div className=" font-semibold md:text-xl text-sm sx:text-base sm:text-lg mb-[10px]">Описание</div>
        ...
        <div>
          <div className=" font-semibold md:text-xl text-sm sx:text-base sm:text-lg mb-[10px]">Расписание</div>
          <div className="mx-[5px] font-roboto font-normal md:text-xl text-sm sx:text-base sm:text-lg">Регистрация с 25.03.2023 - 15:30 по 15.04.2023 - 15:30.</div>
          <div className="mx-[5px] font-roboto font-normal md:text-xl text-sm sx:text-base sm:text-lg">Проведение соревнований с  16.04.2023 - 12:00 по 16.04.2023 - 16:30.</div>
        </div>
        <div>
          <div className=" font-semibold md:text-xl text-sm sx:text-base sm:text-lg mb-[10px]">Материалы</div>
          <Link to="#" className="mx-[5px] font-roboto font-normal md:text-xl text-sm sx:text-base sm:text-lg text-[rgb(9,34,253)]">Материал№1</Link>

        </div>

        <div className="flex flex-col sm:flex-row justify-between w-full ">
          <div className="w-full sm:w-1/2 flex flex-col gap-[10px] mb-[10px]">
            <div className="  font-semibold md:text-xl text-sm sx:text-base sm:text-lg mb-[10px]">Организаторы</div>
            <CardSponOrg />
          </div>
          <div className="w-full sm:w-1/2 flex flex-col gap-[10px]">
            <div className="  font-semibold md:text-xl text-sm sx:text-base sm:text-lg mb-[10px]">Спонсоры</div>
            <CardSponOrg />
          </div>
